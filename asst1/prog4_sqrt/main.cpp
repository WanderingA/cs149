...
extern void sqrt_avx(int N, float initialGuess, float* value, float* output);
...
int main() {
    ...
    for (unsigned int i=0; i<N; i++)
    {
        ...
        // values[i] = .5f + 2.f * static_cast<float>(rand()) / RAND_MAX;             // 尽可能迭代次数相似，加速
    }
